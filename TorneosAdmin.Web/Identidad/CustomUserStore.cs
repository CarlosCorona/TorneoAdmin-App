...
namespace TorneosAdmin.Web.Identidad
{
    public class CustomUserStore :
        ...
        //IUserSecurityStampStore<ApplicationUser>, //No Implementado
        //IUserClaimStore<ApplicationUser>, //No Implementado
        //IUserAuthenticationTokenStore<ApplicationUser>, //No Implementado
        //IUserTwoFactorStore<ApplicationUser>, //No Implementado
        ...
        IQueryableUserStore<ApplicationUser>
    {
        ...
        public CustomUserStore(ModelEntities db)
        {
            _db = db;
        }
        ...
        public Task<IdentityResult> DeleteAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            try
            {
                ...
                _db.Usuarios.Remove(userEntity);
                _db.SaveChanges();
        ...
        public Task<ApplicationUser> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            var userEntity = _db.Usuarios.Find(Convert.ToInt32(userId));
        ...
        public Task<IdentityResult> UpdateAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            try
            {
                ...
                _db.Usuarios.Update(userEntity);
                _db.SaveChanges();
        ...
        public Task<ApplicationUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken)
        {
            ...
            var userEntity = _db.Usuarios.First(x => x.Usuario.ToUpper() == normalizedEmail);
        ...
        public Task AddLoginAsync(ApplicationUser user, UserLoginInfo login, CancellationToken cancellationToken)
        {
            ...
            var loginEntity = new UsuariosLogins
            {
            ...
            _db.UsuariosLogins.Add(loginEntity);
            _db.SaveChanges();
        ...
        public Task RemoveLoginAsync(ApplicationUser user, string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            var usuarioLogin = _db.UsuariosLogins.First(x => x.UserId == user.Id &&
                                                             x.LoginProvider == loginProvider &&
                                                             x.ProviderKey == providerKey);
            _db.UsuariosLogins.Remove(usuarioLogin);
            _db.SaveChanges();
        ...
        public Task<IList<UserLoginInfo>> GetLoginsAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            IList<UserLoginInfo> result = _db.UsuariosLogins.Where(x => x.UserId == user.Id)
        ...
        public Task<ApplicationUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            var loginEntity = _db.UsuariosLogins.First(x => x.LoginProvider == loginProvider &&
                                                            x.ProviderKey == providerKey);
            if (loginEntity == null)
                return Task.FromResult(default(ApplicationUser));

            var userEntity = _db.Usuarios.Find(loginEntity.UserId);
        ...
        public Task<IList<string>> GetRolesAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            if (user == null)
                throw new ArgumentNullException(nameof(user));
            var roles = _db.UsuariosRoles.Where(x => x.UsuarioID == Convert.ToInt32(user.Id))
                                         .Select(x => x.RolID)
                                         .ToList();
            IList<string> result = _db.Roles.Where(x => roles.Contains(x.ID))
        ...
        public Task<IList<ApplicationUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken)
        {
            ...
            if (string.IsNullOrWhiteSpace(roleName))
                throw new ArgumentNullException(nameof(roleName));
            var rol = _db.Roles.First(x => x.Descripcion == roleName);
            var usuarios = _db.UsuariosRoles.Where(x => x.RolID == rol.ID).Select(x => x.UsuarioID);
            IList<ApplicationUser> result = _db.Usuarios.Where(x => usuarios.Contains(x.ID))
                                                        .Select(x => GetApplicationUser(x))
                                                        .ToList();
        ...
        #region IUserSecurityStampStore<ApplicationUser> Members No implementado
        ...
        #region IUserClaimStore<ApplicationUser> Members No implementado
        ...
        #region IUserAuthenticationTokenStore<ApplicationUser> Members No implementado
        ...
        #region IUserTwoFactorStore<ApplicationUser> Members No implementado
        ...
        public Task<int> IncrementAccessFailedCountAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(++user.Intentos);
        }
        ...
        public Task<bool> GetLockoutEnabledAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(user.Bloqueo);
        }
        ...
        private static Usuarios GetUserEntity(ApplicationUser applicationUser)
        {
            return applicationUser == null
                ...
                : new Usuarios
                {
                    ...
                    ApellidoPaterno = applicationUser.ApellidoPaterno,
                    ApellidoMaterno = applicationUser.ApellidoMaterno,
        ...
        private static ApplicationUser GetApplicationUser(Usuarios entity)
        {
            return entity == null
