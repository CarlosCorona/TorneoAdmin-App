#pragma checksum "D:\AdminTorneos\Web\TorneosAdmin.Web\TorneosAdmin.Web\Views\Administracion\Usuarios.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4037dc23d9b63214b6ebe65025887d85a2235a57"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4037dc23d9b63214b6ebe65025887d85a2235a57", @"/Views/Administracion/Usuarios.cshtml")]
...
<script type=""text/javascript"">
    ...
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            mtype: 'GET',
            height: 250,
            colNames: [' ', 'ID', 'Usuario', 'Nombre', 'Apellido Paterno', 'Apellido");
            WriteLiteral(@" Materno', 'Correo Electrónico', 'Telefono', 'Eliminado'],
            colModel: [
                {
                ...
                { name: 'a");
            WriteLiteral(@"pellidoPaterno', index: 'apellidoPaterno', width: 150, editable: true, editoptions: { size: ""20"", maxlength: ""30"" } },
        ...
        jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            },
            {
                ...
                editData: {
                    ...
                    __RequestVerificationToken: function () {
                        return jQue");
            WriteLiteral(@"ry(""input[name=__RequestVerificationToken]"").val();
                    }
                },
            },
            {
        ...
        function style_delete_form(form) {
            ...
            buttons.eq(1).a");
            WriteLiteral(@"ddClass('btn-default').prepend('<i class=""ace-icon fa fa-times""></i>')
        }
...
");
    ...
    ");
            WriteLiteral(@"        $('.ui-jqgrid-labels th[id*=""_cb""]:first-child')
        ...
        function updateActionIcons(table) {
            ...
            $(table).find('.ui-pg-div span.ui-icon').each(function(){
                ...
                if($class in replacement) icon.attr('class', 'ui-icon '+r");
            WriteLiteral(@"eplacement[$class]);
            })
            */
        }
